...
export const APIreact = (reaction, msgDate, username) => axios.post("/api/message/react", {reaction, msgDate, username})
export const APIchangeProfilePic = (profilePic) => axios.post("/api/change_profile_pic", {profilePic})
export const APIgetUser = (username) => axios.get(`/api/user/${username}`)